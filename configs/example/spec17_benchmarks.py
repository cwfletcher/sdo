...
libsvm = Process()
libsvm.executable = 'svm-train'
libsvm.cmd = [libsvm.executable] + ['heart_scale']
...
# [Neil]
#462.libquantum sanity check
sanity = Process()  # Update June 7, 2017: This used to be LiveProcess()
sanity.executable = 'sanity' + x86_suffix
# TEST CMDS
#libquantum.cmd = [libquantum.executable] + ['33','5']
# REF CMDS [UPDATE 10/2/2015]: Sparsh Mittal has pointed out the correct input for libquantum should be 1397 and 8, not 1297 and 8. Thanks!
sanity.cmd = [libquantum.executable] + ['1397', '8']
#libquantum.output = out_dir + 'libquantum.out'
...
# xalancbmk_r
xalancbmk_r = Process()
xalancbmk_r.executable = "cpuxalan_r"
xalancbmk_r.cmd = ["cpuxalan_r"] + ["-v", "t5.xml", "xalanc.xsl"]
...
# cactuBSSN_r
cactuBSSN_r = Process()
cactuBSSN_r.executable = "cactusBSSN_r"
cactuBSSN_r.cmd = ["cactusBSSN_r"] + ["spec_ref.par"]
...
# gcc_r
gcc_r = Process()
gcc_r.executable = "cpugcc_r"
gcc_r.cmd = ["cpugcc_r"] + ["gcc-pp.c", "-O3", "-finline-limit=0", "-fif-conversion", "-fif-conversion2", "-o", "gcc-pp.opts-O3_-finline-limit_0_-fif-conversion_-fif-conversion2.s"]
